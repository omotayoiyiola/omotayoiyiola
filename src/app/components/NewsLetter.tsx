          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex flex-col md:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 border rounded-lg dark:text-white border-gray-300 dark:border-gray-600 bg-white text-gray-600 dark:bg-dark focus:outline-none focus:ring-2 focus:ring-primary"
              />
